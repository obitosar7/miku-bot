...
const dir = [
  ...
  'https://telegra.ph/file/aa8bd2a777b01d0b24f4f.jpg',
  'https://telegra.ph/file/a915d3752bac387b81adf.jpg',
...
let handler = async (m, { conn }) => {
  ...
  const joanimiimg = await prepareWAMessageMedia({ image: { url: randomImage } }, { upload: conn.waUploadToServer });

  const interactiveMessage = {
    body: { text: '*🌸╎❯ اضـغـط عـلـي الـزر لـأرسـال واحـده اخـري*\n\n> *🌷ണĨƘ♡ β♡Ƭ ¦ 仲見*' },
    header: {
    ...
    nativeFlowMessage: {
      buttons: [
        {
          name: "quick_reply",
          buttonParamsJson: `{"display_text":"༺⊱الـتــالـي‌⊰༻","id":".ميمز"}`
        },
        {
          name: "cta_url",
